...
<b><a href="https://github.com/A9FM/filesUB/blob/main/README.md">© Copyright SAWUSERBOT ©</a></b>
...
Если нужна помощь, пиши @sawandr""", disable_web_page_preview=True)
...
async def beta(client: Client, message: Message):
    ...
    os.remove("bot.py")
    url = 'https://raw.githubusercontent.com/Braw

/ClipUserbot/beta/bot.py'
    wget.download(url, '')
    await restart(message, restart_type='update')
